...
function liveMap(updated){
  ...
  return '<section class="screen no-nav fullbleed-header live-map-screen">'+top("京都 2泊3日",true)+'<div class="map">'+
...
function story(){
  return '<section class="screen no-nav fullbleed-header story-screen"><div class="story">'+top("",true)+'<div class="hero trip-photo"><div class="hero-copy"><div class="caption">HIROSHI’S TRIP</div><h1 class="h2">京都で見つけた、家族の時間</h1><p class="small">SEP 21 - 23</p></div></div><div class="section">'+stats()+'</div><div class="section ai"><div class="ai-tag">TRAVEL STORY</div><p class="body" style="margin-top:6px">旅程、ルート、写真、スタンプ、日記がひとつの物語としてつながります。</p></div><div class="section">'+stampStrip(state.stamps)+'</div><button class="btn red" style="margin-top:22px" data-action="new-trip">ATTA!で自分の旅をつくる</button></div></section>';
}
function plans(){
